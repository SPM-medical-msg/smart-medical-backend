...
public class MyMqttPahoMessageDrivenChannelAdapter extends AbstractMqttMessageDrivenChannelAdapter
    implements MqttCallback, MqttCallbackExtended, ApplicationEventPublisherAware {
     ...
     */
    public MyMqttPahoMessageDrivenChannelAdapter(String url, String clientId, MqttPahoClientFactory clientFactory,
        String... topic) {
     ...
     * @since 4.1
     */
    public MyMqttPahoMessageDrivenChannelAdapter(String clientId, MqttPahoClientFactory clientFactory,
        String... topic) {
        ...
        try {
            this.reconnectFuture = getTaskScheduler().schedule(() -> {
                try {
                    ...
                    synchronized (MyMqttPahoMessageDrivenChannelAdapter.this) {
                        if (!MyMqttPahoMessageDrivenChannelAdapter.this.connected) {
                            connectAndSubscribe();
                            MyMqttPahoMessageDrivenChannelAdapter.this.reconnectFuture = null;
                        }
                    }
                }
                catch (MqttException e) {
